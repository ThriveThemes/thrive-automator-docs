...
add_action( 'thrive_automator_init', static function () {
	...
	thrive_automator_register_action_field( new \AutomatorExamples\Actions\General\Fields\Url() );
	...
	thrive_automator_register_action_field( new \AutomatorExamples\Actions\Ultimatum\Fields\CampaignId() );
